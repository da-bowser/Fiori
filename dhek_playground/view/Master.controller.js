sap.ui.core.mvc.Controller.extend("dk.dhek.fiori.view.Master", {
	...
	loadDetailView : function(){
		this.getRouter().myNavToWithoutHash({ 
			...
			targetViewName : "dk.dhek.fiori.view.Detail",
			targetViewType : "XML"
		});
	},
	...
	onSearch : function() {
		...
		if (searchString && searchString.length > 0) {
			filters = [ new sap.ui.model.Filter("UserCreate", sap.ui.model.FilterOperator.Contains, searchString) ];
		}
		// Update list binding
